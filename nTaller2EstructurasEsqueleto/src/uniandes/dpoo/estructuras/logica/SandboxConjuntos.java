...
public class SandboxConjuntos
{
    ...
    {
    	TreeSet<String> invertida = new TreeSet<>(((TreeSet<String>) arbolCadenas).descendingSet());
        return List.copyOf(invertida);
    }
    ...
    {
    	TreeSet<String> elementosAEliminar = new TreeSet<>();
        for (String str : arbolCadenas) {
            if (str.equalsIgnoreCase(cadena)) {
                elementosAEliminar.add(str);
            }
        }
        arbolCadenas.removeAll(elementosAEliminar);
    }
    ...
    {
        return new TreeSet<>(((TreeSet<String>) arbolCadenas).descendingSet());
    }
